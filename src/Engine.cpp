...
namespace silk
{
    ...
    RenderPassContext::RenderPassContext(const DeviceContext &deviceContext) : device(deviceContext.getDevice())
    {
        ...
        std::cout << "Create RenderPassContext\n";
    }
    ...
    VkRenderPass RenderPassContext::getRenderPass() const { return renderPass; }
    ...
    DescriptorSetLayoutContext::DescriptorSetLayoutContext(const VkDevice device, const std::vector<VkDescriptorSetLayoutBinding>& bindings) : device(device)
    {
